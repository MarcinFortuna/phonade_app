...
export const sentences: transcription_sentence[] = [
    {id: 1, spelling: "The problem is that the change might be small.", sampa: "D@ \"prQbl@m Iz D@t D@ \"tSeIndZ maIt bi \"smO:l", sampa_regex: /D@ "prQbl[@I](m Iz|mz) D[@{]t D@ "tSeIndZ "?maIt bi "smO:l/},
    {id: 2, spelling: "I would like to be a hero.", sampa: "aI w@d \"laIk t@ bi @ \"hI@r@U", sampa_regex: /"?aI w[@U]d "?laIk t@ bi @ "hI@r@U/},
    {id: 3, spelling: "I will never give you up.", sampa: "aI wIl \"nev@ gIv ju \"Vp", sampa_regex: /aI wIl "?nev@ "?gIv ("?ju:|ju) "Vp/},
    {id: 4, spelling: "He stood by what he said.", sampa: "hi \"stUd \"baI wQt hi \"sed", sampa_regex: /hi "stUd "?baI "?wQt hi "sed/},
    {id: 5, spelling: "There are around one hundred possible combinations.", sampa: "D@r @r @\"raUnd wVn \"hVndr@d \"pQs@b@l %kQmbI\"neIʃ@nz", sampa_regex: /D@r @r @"raUnd "?wVn "hVndr@d "pQs@b@l %?kQmbI"neIʃ@nz/},
    {id: 6, spelling: "There are some people willing to help you.", sampa: "D@r @ s@m \"pi:p@l \"wIlIN t@ \"help ju:", sampa_regex: /D@r @ (s@m|"?sVm) "pi:p@l "wIlIN t@ "help (ju|"?ju:)/},
    {id: 7, spelling: "She has a new bag.", sampa: "ʃi h{z @ \"nju: \"b{g", sampa_regex: /ʃi "?h{z @ "?nju: "b{g/},
    {id: 8, spelling: "He likes swimming on sunny days.", sampa: "hi laIks \"swImIN Qn \"sVni \"deIz", sampa_regex: /hi "?laIks "swImIN Qn "?sVni "deIz/},
    {id: 9, spelling: "First come, first served.", sampa: "f3:st \"kVm | f3:st \"s3:vd", sampa_regex: /"?f3:st "kVm \| "?f3:st "s3:vd/},
    {id: 10, spelling: "If they lived in Spain, they would be happy.", sampa: "If DeI \"lIvd In \"speIn | DeI w@d bi \"h{pi", sampa_regex: /"?If DeI "lIvd In "speIn( \|)? DeI w[@U]d bi "h{pi/},
    {id: 11, spelling: "Another person is sick.", sampa: "@\"nVD@ \"p3:s@n Iz \"sIk", sampa_regex: /@"nVD@ "p3:s@(n Iz|z) "sIk/},
    {id: 12, spelling: "This school is very old.", sampa: "DIs \"sku:l Iz \"veri \"@Uld", sampa_regex: /"?DIs "sku:l( Iz|z) "?veri "@Uld/},
    {id: 13, spelling: "I bought some apples from the local market.", sampa: "aI \"bO:t s@m \"{p@lz fr@m D@ \"l@Uk@l \"mA:kIt", sampa_regex: /aI "bO:t s[@V]m "{p@lz fr[@Q]m D@ "l@Uk@l "mA:k[I@]t/},
    {id: 14, spelling: "I'm going to the cinema with Mary and her sister.", sampa: "aIm \"g@UIN t@ D@ \"sIn@m@ wID \"me@ri @nd h@ \"sIst@", sampa_regex: /aIm "g@UIN t@ D@ "sIn@m@ wID "me@ri @nd? h(@|3:) "sIst@/},
    {id: 15, spelling: "All people can do good.", sampa: "\"O:l \"pi:p@l k@n \"du: \"gUd", sampa_regex: /"?O:l "pi:p@l (k@n|"?k{n) ("?du:|du) "gUd/},
    {id: 16, spelling: "We have to go because we have a long journey ahead of us.", sampa: "wi \"h{v t@ \"g@U bI\"kQz wi \"h{v @ \"lQN \"dZ3:ni @\"hed @v Vs", sampa_regex: /wi "?h{v t@ "g@U( \|)? b[Ii@]"k(Q|V|O:)z wi "h{v @ "?lQN "dZ3:ni @"hed @v "?Vs/},
    {id: 17, spelling: "This is by far the best experience i have ever had.", sampa: "DIs Iz baI \"fA: D@ \"best Iks\"pI@rI@ns aI h@v \"ev@ \"h{d", sampa_regex: /"?DIs Iz "?baI "fA: D@ "?best Iks"pI@rI@ns aI( h@v|v) "?ev@ "h{d/},
    {id: 18, spelling: "He looked like he was lost.", sampa: "hi \"lUkt laIk hi w@z \"lQst", sampa_regex: /hi "?lUkt laIk hi w[@Q]z "lQst/},
    {id: 19, spelling: "Only a year ago did I realize I was wrong.", sampa: "\"@Unli @ \"jI@r @\"g@U dId aI \"rI@laIz aI w@z \"rQN", sampa_regex: /"?@Unli @ "jI@r @"g@U dId aI "rI@laIz aI w[@Q]z "rQN/},
    {id: 20, spelling: "I could not find a new pair of socks.", sampa: "aI k@d \"nQt \"faInd @ \"nju: \"pe@r @v \"sQks", sampa_regex: /aI k[@U]d "nQt "faInd @ "?nju: "?pe@r @v "sQks/},
    {id: 21, spelling: "Little did I know about the world.", sampa: "\"lIt@l dId aI \"n@U @\"baUt D@ \"w3:ld"},
    ...
    {id: 52, spelling: "Last Christmas is the most played song during the holiday season.", sampa: "\"lA:st \"krIsm@s Iz D@ \"m@Ust \"pleId \"sQN djU@rIN D@ \"hQl@deI \"si:z@n"},
