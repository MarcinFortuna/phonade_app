...
export const SeeList = () => {
    ...
    return (
        <>
            <label htmlFor="vocab-list-modal" className="cursor-pointer" title="See the full list">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" strokeWidth={1.5}
